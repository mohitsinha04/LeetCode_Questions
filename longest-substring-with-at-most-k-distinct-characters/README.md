<h2>340. Longest Substring with At Most K Distinct Characters</h2><h3>Hard</h3><hr><div><p>Given a string, find the length of the longest substring T that contains at most <i>k</i> distinct characters.</p>
