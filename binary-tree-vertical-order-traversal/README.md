<h2>314. Binary Tree Vertical Order Traversal</h2><h3>Medium</h3><hr><div><p>Given a binary tree, return the <i>vertical order</i> traversal of its nodes' values. (ie, from top to bottom, column by column).</p>
